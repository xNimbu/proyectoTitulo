...
urlpatterns = [
    ...
    # GET  /api/profile/                       → Obtener perfil + pets + posts + role/code
    # POST /api/profile/                       → Crear/Actualizar perfil
    path("profile/", views.profile, name="profile"),
    # GET  /api/profile_list/                  → Listar perfiles públicos
    ...
    # ------------------------------
    # GET  /api/profile/friends/               → Listar amigos (user/admin)
    # POST /api/profile/friends/               → Agregar un amigo
    path("profile/friends/", views.friends, name="friends"),
    # DELETE /api/profile/friends/<friend_uid>/→ Eliminar un amigo
    path(
